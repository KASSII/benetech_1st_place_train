class CFG:
    ...
    # Training
    pretrain_weight = "../datas/output/Benetech_AllChartTrain_v1/20230602234838"
    ...
    train_csv_list = [
        ...
        {
            "csv_path": "../datas/input/ICDAR_2022/manual_annotation/line/ICDAR_manualannot_line_4fold.csv",
            "data_path": "../datas/input/ICDAR_2022/manual_annotation/line",
            "train_folds": [0,2,3],
            "val_folds": []
        },
    ]
    ...
    seed = 42
    warmup_steps = 300  
    output_path = "../datas/output/Benetech_SpecificChartTrain_Line"
    log_steps = 200
    batch_size = 2
    val_batch_size = 4
    use_wandb = False
